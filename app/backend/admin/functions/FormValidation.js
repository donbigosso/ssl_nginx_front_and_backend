 ...
 *
 * Keep in sync with frontend/functions/FormValidation.js where rules overlap.
 */
...
export const VALIDATION_CONSTRAINTS = {
  ...
  // Gallery (shared rules; used if admin UI edits collections)
